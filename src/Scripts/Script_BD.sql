...
VALUES ('1', '18', '26', 'NON', '0', '2000', false, '1', '11.34'),
       ('2', '18', '26', 'NON', '0', '2000', false, '2', '10.47'),
       ('3', '81', '999', 'NON', '0', '2000', false, '1', '14.85'),
       ('4', '27', '60', 'NON', '0', '2000', false, '1', '9.76'),
       ('5', '27', '60', 'NON', '0', '2000', false, '2', '9.79'),
       ('6', '81', '999', 'NON', '0', '2000', false, '2', '14.9'),
       ('7', '61', '80', 'NON', '0', '2000', false, '1', '9.47'),
       ('8', '61', '80', 'NON', '0', '2000', false, '2', '9.52'),    
       ('10', '18', '26', 'cdd', '0', '2000', false, '1', '6.8'),
       ('11', '18', '26', 'cdd', '0', '2000', false, '2', '6.61'),
       ('12', '81', '999', 'cdd', '0', '2000', false, '1', '9.95'),
       ('13', '27', '60', 'cdd', '0', '2000', false, '1', '7.5'),
       ('14', '27', '60', 'cdd', '0', '2000', false, '2', '7.55'),
       ('15', '81', '999', 'cdd', '0', '2000', false, '2', '13.6'),
       ('16', '61', '80', 'cdd', '0', '2000', false, '1', '8'),
       ('17', '61', '80', 'cdd', '0', '2000', false, '2', '8.4'),
       ('19', '18', '26', 'cdi', '0', '2000', false, '1', '7.4'),
       ('20', '18', '26', 'cdi', '0', '2000', false, '2', '7.91'),
       ('21', '81', '999', 'cdi', '0', '2000', false, '1', '13.06'),
       ('22', '27', '60', 'cdi', '0', '2000', false, '1', '7.75'),
       ('23', '27', '60', 'cdi', '0', '2000', false, '2', '7.99'),
       ('24', '81', '999', 'cdi', '0', '2000', false, '2', '13.19'),
       ('25', '61', '80', 'cdi', '0', '2000', false, '1', '8.44'),
       ('26', '61', '80', 'cdi', '0', '2000', false, '2', '6.73'),
       ('28', '18', '26', 'NON', '0', '2000', true, '1', '5.54'),
       ('29', '18', '26', 'NON', '0', '2000', true, '2', '5.74'),
       ('30', '81', '999', 'NON', '0', '2000', true, '1', '9.88'),
       ('31', '27', '60', 'NON', '0', '2000', true, '1', '4.64'),
       ('32', '27', '60', 'NON', '0', '2000', true, '2', '4.84'),
       ('33', '81', '999', 'NON', '0', '2000', true, '2', '9.99'),
       ('34', '61', '80', 'NON', '0', '2000', true, '1', '5.75'),
       ('35', '61', '80', 'NON', '0', '2000', true, '2', '5.84'),
       ('37', '18', '26', 'cdd', '0', '2000', true, '1', '5.04'),
       ('38', '18', '26', 'cdd', '0', '2000', true, '2', '5.14'),
       ('39', '81', '999', 'cdd', '0', '2000', true, '1', '9.91'),
       ('40', '27', '60', 'cdd', '0', '2000', true, '1', '5.34'),
       ('41', '27', '60', 'cdd', '0', '2000', true, '2', '5.54'),
       ('42', '81', '999', 'cdd', '0', '2000', true, '2', '10.04'),
       ('43', '61', '80', 'cdd', '0', '2000', true, '1', '5.34'),
       ('44', '61', '80', 'cdd', '0', '2000', true, '2', '5.53'),
       ('46', '18', '26', 'cdi', '0', '2000', true, '1', '5.23'),
       ('47', '18', '26', 'cdi', '0', '2000', true, '2', '5.24'),
       ('48', '81', '999', 'cdi', '0', '2000', true, '1', '10.4'),
       ('49', '27', '60', 'cdi', '0', '2000', true, '1', '6.04'),
       ('50', '27', '60', 'cdi', '0', '2000', true, '2', '5.94'),
       ('51', '81', '999', 'cdi', '0', '2000', true, '2', '10.45'),
       ('52', '61', '80', 'cdi', '0', '2000', true, '1', '5.334'),
       ('53', '61', '80', 'cdi', '0', '2000', true, '2', '5.43'),

       ('55', '18', '26', 'NON', '2000', '999999', false, '1', '6.94'),
       ('56', '18', '26', 'NON', '2000', '999999', false, '2', '7.02'),
       ('57', '81', '999', 'NON', '2000', '999999', false, '1', '13.33'),
       ('58', '27', '60', 'NON', '2000', '999999', false, '1', '7.04'),
       ('59', '27', '60', 'NON', '2000', '999999', false, '2', '7.24'),
       ('60', '81', '999', 'NON', '2000', '999999', false, '2', '14.39'),
       ('61', '61', '80', 'NON', '2000', '999999', false, '1', '7.14'),
       ('62', '61', '80', 'NON', '2000', '999999', false, '2', '7.45'),
       
       ('64', '18', '26', 'cdd', '2000', '999999', false, '1', '7.4'),
       ('65', '18', '26', 'cdd', '2000', '999999', false, '2', '7.74'),
       ('66', '81', '999', 'cdd', '2000', '999999', false, '1', '13.91'),
       ('67', '27', '60', 'cdd', '2000', '999999', false, '1', '7.77'),
       ('68', '27', '60', 'cdd', '2000', '999999', false, '2', '7.81'),
       ('69', '81', '999', 'cdd', '2000', '999999', false, '2', '14.94'),
       ('70', '61', '80', 'cdd', '2000', '999999', false, '1', '7.30'),
       ('71', '61', '80', 'cdd', '2000', '999999', false, '2', '7.64'),
  
       ('73', '18', '26', 'cdi', '2000', '999999', false, '1', '7.40'),
       ('74', '18', '26', 'cdi', '2000', '999999', false, '2', '7.54'),
       ('75', '81', '999', 'cdi', '2000', '999999', false, '1', '13.71'),
       ('76', '27', '60', 'cdi', '2000', '999999', false, '1', '7.5'),
       ('77', '27', '60', 'cdi', '2000', '999999', false, '2', '7.64'),
       ('78', '81', '999', 'cdi', '2000', '999999', false, '2', '14.94'),
       ('79', '61', '80', 'cdi', '2000', '999999', false, '1', '7.42'),
       ('80', '61', '80', 'cdi', '2000', '999999', false, '2', '7.54'),
 
       ('82', '18', '26', 'NON', '2000', '999999', true, '1', '5.04'),
       ('83', '18', '26', 'NON', '2000', '999999', true, '2', '5.14'),
       ('84', '81', '999', 'NON', '2000', '999999', true, '1', '12.4'),
       ('85', '27', '60', 'NON', '2000', '999999', true, '1', '5.31'),
       ('86', '27', '60', 'NON', '2000', '999999', true, '2', '5.41'),
       ('87', '81', '999', 'NON', '2000', '999999', true, '2', '12.54'),
       ('88', '61', '80', 'NON', '2000', '999999', true, '1', '5.48'),
       ('89', '61', '80', 'NON', '2000', '999999', true, '2', '5.50'),

       ('91', '18', '26', 'cdd', '2000', '999999', true, '1', '5.15'),
       ('92', '18', '26', 'cdd', '2000', '999999', true, '2', '5.24'),
       ('93', '81', '999', 'cdd', '2000', '999999', true, '1', '12.56'),
       ('94', '27', '60', 'cdd', '2000', '999999', true, '1', '5.64'),
       ('95', '27', '60', 'cdd', '2000', '999999', true, '2', '5.4'),
       ('96', '81', '999', 'cdd', '2000', '999999', true, '2', '12.88'),
       ('97', '61', '80', 'cdd', '2000', '999999', true, '1', '5.23'),
       ('98', '61', '80', 'cdd', '2000', '999999', true, '2', '5.38'),

       ('100', '18', '26', 'cdi', '2000', '999999', true, '1', '5.51'),
       ('101', '18', '26', 'cdi', '2000', '999999', true, '2', '5.53'),
       ('102', '81', '999', 'cdi', '2000', '999999', true, '1', '12.6'),
       ('103', '27', '60', 'cdi', '2000', '999999', true, '1', '5.34'),
       ('104', '27', '60', 'cdi', '2000', '999999', true, '2', '5.42'),
       ('105', '81', '999', 'cdi', '2000', '999999', true, '2', '12.56'),
       ('106', '61', '80', 'cdi', '2000', '999999', true, '1', '5.5'),
       ('107', '61', '80', 'cdi', '2000', '999999', true, '2', '5.65');
